...
def parse_args():
    ...
    parser.add_argument('--x', type=float, required=True, help='X coord of stimulation target')
    parser.add_argument('--y', type=float, required=True, help='Y coord of stimulation target')
    parser.add_argument('--z', type=float, required=True, help='Z coord of stimulation target')
...
def optimize(
    ...
    outdir = Path(outdir)
    simoutdir = outdir / 'Optimize/Simulation'
    simoutdir.mkdir(exist_ok=True, parents=True)
